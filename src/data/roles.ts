...
export const roles: Role[] = [
  {
    ...
    skills: [
      { text: 'JavaScript', order: 3, top: true, category: 'Languages' },
      { text: 'PHP', order: 2, top: true, category: 'Languages' },
      { text: 'Playwright', order: 2, top: false, category: 'Languages' },
      { text: 'Monolith', order: 30, top: false },
      { text: 'DigitalOcean', order: 30, top: false },
      { text: 'AWS', order: 30, top: true },
      { text: 'Mentoring', order: 34, top: true },
      { text: 'AI Feature Development', order: 31, top: false },
      { text: 'Test First Development', order: 35, top: true },
      { text: 'System Design', order: 32, top: true },
      { text: 'Claude Code', order: 31, top: true },
      { text: 'MySQL', order: 33, top: true },
    ],
  },
  {
    ...
    skills: [
      ...
      { text: 'Python', order: 3, top: false, category: 'Languages' },
      { text: 'Kotest', order: 3, top: false, category: 'Languages' },
      { text: 'AI Feature Development', order: 3, top: true, category: 'Languages' },
      { text: 'Microservices', order: 30, top: true },
      { text: 'AWS', order: 31, top: true },
      { text: 'Datadog', order: 31, top: false },
      { text: 'Claude Code', order: 31, top: true },
  ...
  },
  {
    ...
    skills: [
      ...
      { text: 'PHP', order: 32, top: true, category: 'Languages' },
      { text: 'PHP Unit', order: 32, top: false, category: 'Languages' },
      { text: 'Laravel', order: 32, top: true, category: 'Frameworks' },
      { text: 'Test First Development', order: 35, top: true },
      { text: 'System Design', order: 32, top: true },
      { text: 'Monolith', order: 30, top: false },
  ...
  },
  {
    ...
    skills: [
      ...
      { text: 'Junit', order: 31, top: false },
      { text: 'Spring Boot', order: 1, top: false, category: 'Frameworks' },
      { text: 'Microservices', order: 30, top: true },
      { text: 'Mentoring', order: 34, top: true },
