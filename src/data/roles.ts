...
export const roles: Role[] = [
  {
    ...
    blurb: [
      ...
      'Improved confidence in future released by introducing Playwright end-to-end tests.',
    ...
    skills: [
      ...
      { text: 'Playwright', order: 2, top: true, category: 'Languages' },
      { text: 'Monolith', order: 30, top: false },
      { text: 'Digital Ocean', order: 30, top: false },
  ...
  },
  {
    ...
    company: 'Canopy',
    blurb: [
      'Increased revenue by co-implementing AI driven features like auto filling forms and questionnaire generation. (Increased ARR by 150K=k in the first 30 days of release)',
